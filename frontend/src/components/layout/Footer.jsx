    ...
    <footer className="border-t border-white/5 bg-black">
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-14 md:grid-cols-2 lg:grid-cols-4 lg:px-8">
        ...
        <div>
          ...
          {/* Social Icons */}
          <div className="mt-6 flex gap-4 text-zinc-400">
            ...
            <a href="https://youtube.com" target="_blank" rel="noreferrer" className="hover:text-yellow-400">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div>
          ...
          <div className="mt-5 space-y-4 text-sm text-zinc-400">
            <div className="flex items-start gap-3">
              ...
              <span>123 Fitness Ave, Muscle City</span>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <span>hello@fitnesscenter.com</span>
            </div>
          </div>
        </div>
      </div>
